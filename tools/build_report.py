...
story.append(Paragraph(
    "Прототип для А. В. Гасникова (научные тропы) &nbsp;·&nbsp; демонстрация на ПМЭФ &nbsp;·&nbsp; 10 июня 2026",
    SUB))
...
story.append(Paragraph(
    ...
    "«манифест Гасникова»: метод вместо фактов, «поперечное сечение реальности».", BODY))
story.append(Paragraph(
...
story.append(kv_table(
    ...
    rows=[
        ...
        ["Манера", "Раздел «в духе Капицы»: темп, паузы, регистр", "Весомость и доверие демо для ПМЭФ"],
