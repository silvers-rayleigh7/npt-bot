...
![Метод конечных элементов: область разбивают на мелкие треугольники и на каждом берут простую функцию. Сшивка «в слабом смысле» Соболева позволяет считать даже негладкие тела с углами и трещинами.](/assets/figures/sobolev-2.svg)
