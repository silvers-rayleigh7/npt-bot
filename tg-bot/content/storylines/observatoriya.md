...
![Горизонт — касательная к шару Земли: радиус в точке касания перпендикулярен лучу зрения.](/assets/figures/observatoriya-1.svg)
...
![Широта равна высоте Полярной: угол $\varphi$ между плоскостью экватора и радиусом в точку наблюдателя равен высоте Полярной над горизонтом. Направление на далёкую звезду параллельно земной оси.](/assets/figures/observatoriya-2.svg)
