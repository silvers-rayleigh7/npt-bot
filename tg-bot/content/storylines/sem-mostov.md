...
[^euler]: Эйлер изложил решение в работе «Solutio problematis ad geometriam situs pertinentis» (1736), представленной Петербургской академии наук; её принято считать первой статьёй по теории графов ([Euler, 1736; обзор — Wikipedia, «Seven Bridges of Königsberg»](https://en.wikipedia.org/wiki/Seven_Bridges_of_K%C3%B6nigsberg)).
