...
![Одни и те же координаты приходят двумя путями: выбиты на латунном репере геодезистами и появляются на смартфоне от спутников.](/assets/figures/sputnik-2.svg)
...
![Трилатерация: каждое измеренное расстояние до спутника задаёт окружность (в пространстве — сферу) возможных положений. Три окружности пересекаются в одной точке — это и есть приёмник.](/assets/figures/sputnik-1.svg)
