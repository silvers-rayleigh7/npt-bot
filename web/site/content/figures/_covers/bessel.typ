...
#cetz.canvas(length: 1pt, {
  ...
  circle((220, 100), radius: 17, fill: rgb("#2E9BD6"), stroke: none)
  circle((220, 100), radius: 44, fill: none, stroke: (paint: rgb("#22333C"), thickness: 2pt, dash: none))
  circle((220, 100), radius: 68, fill: none, stroke: (paint: rgb("#7A6FE0"), thickness: 2pt, dash: none))
  ...
  circle((172, 148), radius: 6.5, fill: rgb("#7A6FE0"), stroke: none)
  circle((285, 35), radius: 5, fill: rgb("#2E9BD6"), stroke: none)
})
