...
#cetz.canvas(length: 1cm, {
  ...
  content((2.7, 1.0), text(size: 7pt, fill: rgb("#FBF8F1"))[мамонт])
  ...
  content((X1 + 0.3, 1.3), anchor: "west", text(size: 9pt, fill: rgb("#FBF8F1"))[вечная мерзлота])
  content((X1 + 0.3, 1.0), anchor: "west", text(size: 7.5pt, fill: rgb("#FBF8F1"))[T < 0 °C тысячи лет])
