...
[^d8]: Алгоритм восьми направлений (D8) для трассировки стока по цифровой модели рельефа предложили О’Каллахан и Марк в 1984 году. [Watershed delineation](https://en.wikipedia.org/wiki/Watershed_delineation)
[^capture]: Колено перехвата — диагностический признак речного пиратства. [Перехват реки](https://ru.wikipedia.org/wiki/Перехват_реки)
